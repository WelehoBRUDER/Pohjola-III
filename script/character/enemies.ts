const enemies = {
  ...
  minotaur_sage: {
    ...
    abilities: [
      { ...(abilities.magical_attack as any) },
      { ...(abilities.fireball as any) },
      { ...(abilities.ice_bolt as any) },
      { ...(abilities.regeneration_spell as any) },
    ],
    loot: [
      {
        gold: [400, 500],
  ...
  minotaur_captain: {
    ...
    abilities: [
      { ...(abilities.physical_attack as any) },
      { ...(abilities.bull_rush as any) },
      { ...(abilities.gore as any) },
      { ...(abilities.bull_rage as any) },
    ],
    loot: [
      {
        gold: [1200, 1800],
