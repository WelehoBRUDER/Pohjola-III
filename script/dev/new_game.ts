...
const characterCreationSections: any = [
  {
    id: "name",
    type: "input",
  },
...
function createNewGame() {
  ...
  Object.values(startingChallenges).forEach((challenge: any) => {
  ...
  characterCreationSections.forEach((section: any) => {
...
function createSectionValue(section: any) {
  ...
  switch (section.type) {
    ...
    case "aspect":
      ...
      section.values.forEach((value: any, index: number) => {
