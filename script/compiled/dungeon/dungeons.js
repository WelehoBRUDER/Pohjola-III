...
const dungeons = [
    {
        ...
        rooms: [
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.skeleton_knight), new Enemy(enemies.skeleton_knight)],
                isBoss: false,
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.skeleton_lord)],
                isBoss: true,
                end: true,
    ...
    },
    {
        ...
        rooms: [
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.goblin), new Enemy(enemies.goblin), new Enemy(enemies.goblin)],
                isBoss: false,
                loot: [{ id: "", item: "gold", amount: 200 }],
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.orc), new Enemy(enemies.orc)],
                isBoss: false,
                loot: [{ id: "", item: "gold", amount: 300 }],
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.troll), new Enemy(enemies.goblin)],
                isBoss: true,
                loot: [
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.orc_chieftain)],
                isBoss: true,
                end: true,
                loot: [
    ...
    },
    {
        ...
        rooms: [
            ...
            new Room({
                ...
                foes: [
                    new Enemy(enemies.minotaur),
                    new Enemy(enemies.minotaur_warrior),
                    new Enemy(enemies.minotaur),
                ],
                isBoss: false,
                loot: [],
            ...
            new Room({
                ...
                foes: [new Enemy(enemies.minotaur_king)],
                end: true,
                isBoss: true,
